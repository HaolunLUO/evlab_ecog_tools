function crunch(varargin)
    ...
    % SETUP
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    REPO_PATH = '/home/sdurai30/repos';
    ORCD_PATH = '/orcd/archive/evelina9/001/DATA/INTRACRANIAL/PRE-MGH';
    CRUNCH_DIR = fileparts(mfilename('fullpath'));
    REPO_ROOT  = fullfile(CRUNCH_DIR, '..', '..');
    addpath(REPO_ROOT);                              % @ecog_data class
    addpath(genpath(fullfile(REPO_ROOT, 'utils')));  % utilities
    DATA_PATH = [ORCD_PATH filesep 'DATA' filesep ops.experiment];
    RAW_PATH = [DATA_PATH filesep ops.subject filesep ops.experiment filesep 'ECOG001'];
    SAVE_PATH = [ORCD_PATH filesep 'crunched' filesep ops.experiment filesep 'crunched_for_merged_pipeline' filesep];
    OP_INFO_PATH = [CRUNCH_DIR filesep 'info' filesep];
    LOG_PATH = [CRUNCH_DIR filesep 'logs' filesep];
   ...
   % save_filename = [SAVE_PATH ops.subject '_' ops.experiment '_crunched.mat'];
    ...
    if ops.fromScratch
        ...
        % add anatomy
        ANATOMY_PATH = [ORCD_PATH filesep 'DATA' filesep '_VERA_ANT' filesep];
        ...
        if strcmp(ops.experiment,'MITNaturalisticStoriesTask') % special instructions for filling in
            ...
            STIM_PATH = [CRUNCH_DIR filesep '..', filesep '..', filesep 'expts' filesep ops.experiment filesep];
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        ANALYSIS_PATH = [ORCD_PATH filesep 'ANALYSIS' filesep 'MITLangloc'];
